...
const initDatabase = async () => {
  try {
    ...
    await createIndexSafe(`CREATE INDEX idx_snippets_public ON snippets (is_public, updated_at)`);
    await createIndexSafe(`CREATE INDEX idx_snippets_public_lang ON snippets (is_public, language)`);
